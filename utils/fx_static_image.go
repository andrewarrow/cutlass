...
func HandleFXStaticImageCommand(args []string) {
	if len(args) < 1 {
		...
		fmt.Println("Creative effects: parallax, breathe, pendulum, elastic, spiral, figure8, heartbeat, wind, kaleido")
...
func isValidEffectType(effectType string) bool {
	validEffects := []string{
		...
		"parallax", "breathe", "pendulum", "elastic", "spiral", "figure8", "heartbeat", "wind", "inner-collapse", "shatter-archive", "potpourri", "variety-pack", "kaleido",
	}
